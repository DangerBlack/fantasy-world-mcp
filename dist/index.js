    ...
    try {
        ...
        switch (name) {
            case 'initializeWorld': {
                const result = toolHandler.initializeWorld(args);
            ...
            case 'getWorldState': {
                const result = toolHandler.getWorldState(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'getTimeline': {
                const result = toolHandler.getTimeline(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'generateLocation': {
                const result = toolHandler.generateLocation(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'exportWorld': {
                const result = toolHandler.exportWorld(args);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'deleteWorld': {
                const result = toolHandler.deleteWorld(args);
                return {
                    content: [
                        {
                            type: 'text',
